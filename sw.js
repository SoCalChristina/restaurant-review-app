const cacheName = "restaurant-reviews-project";
const staticCacheName = "restaurant-reviews-project-v1.0";
const contentImgsCache = "restaurant-reviews-project-images";
var allCaches = [
    staticCacheName,
    contentImgsCache
];
        ...
        caches.keys().then(function (cacheNames) {
            return Promise.all(
                cacheNames.filter(function (cacheName) {
                    return cacheName.startsWith('restaurant-project-master') &&
